const OrdendeRetiro = ({formatDate, ordenRealizada, ordenId, terminarCompra}) => {
    let productos = [];
    ...
    function cargarProductos (){
        ordenRealizada.productos.map((item) => {
            ...
            Local a Retirar: ${ordenRealizada.localDeRetiro}
            ...
            <div className="OrdenContenedor">
                <div className="OrdenDeEnvioContainer">
                    ...
                    <div className="ordenDeEnvio__local">
                        <p>Local a Retirar: <span>{ordenRealizada.localDeRetiro}</span></p>
                    </div>
